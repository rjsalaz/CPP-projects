/*
 ...
 Program: RoundRobinTimeSlice5.cs
 Due Date: 4/7/2020
 Description: This is my implementation of the Round Robin with Time Slice 5 algorithm. I left code that was used to test 20 trials of 20 sets in the program, 
...
namespace RoundRobinTimeSlice5

{
    class RoundRobinTimeSlice5
    {
        ...
        static int[] RoundRobin(int[] jobs, string[] jobsList, int timeSlice)
        {
            ...
            int EndTime = 0;
            int difference;
            Console.WriteLine("*************************** Round Robin Time Slice 5 ***************************");
            while (true)
            {
                bool isDone = true;
        ...
        static void Main()
        {
            ...
            while (outterCounter < 20)
            {
                ...
                //This code is used for the while loop that is used to test 20 sets of jobs
                while (counter < 20)
                {
                */
